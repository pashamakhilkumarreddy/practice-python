...
def first_non_repeating_char_sol_three(s: str) -> int:
...
print(first_non_repeating_char_sol_three('gwenstacy'))
print(first_non_repeating_char_sol_three('alphabet'))
print(first_non_repeating_char_sol_three('benjaminbyrnison'))